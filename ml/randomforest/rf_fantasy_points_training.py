...
total_fantasy_points = combined[(combined["season"] == 2025) & (combined["week"] <= 7)] \
...
last_week[["player_id", "name", "predicted_fantasy_points"]].to_csv("predictions/week7_fantasy_predictions.csv", index=False)
