...
leak_cols = [
    ...
    "rushing_yards", "reception", "total_touches", "rush_inside_10", "rush_inside_20", "target_inside_10", "target_inside_20",
    ...
    "pressure_rate_def","man_coverage_pct_def","zone_coverage_pct_def"
]
