...
total_passing_yards = combined[(combined["season"] == 2025) & (combined["week"] <= 7)] \
...
# Predict week 8
# -------------------------
# Use week 7 as a pseudo-test set
...
last_week[["player_id", "name", "predicted_passing_yards"]].to_csv("predictions/week8_passing_predictions.csv", index=False)
