...
features = [
    ...
    "receiving_yards_rolling3", "reception_rolling3", "rush_touchdown_rolling3", "passing_yards", 
...
# -------------------------------
model.save_model("../model_files/lgb_qb_fantay_points.txt")

pd.DataFrame({
    "player_id": pid_test,
    "actual_receiving_yards": y_test,
    "predicted_receiving_yards": y_pred
}).to_csv("../prediction_files/predicted_qb_fantay_points_2024.csv", index=False)
